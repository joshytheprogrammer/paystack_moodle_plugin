 ...
 */
 ...
 class enrol_paystack_plugin extends enrol_plugin
 {
     ...
     {
         return $this->get_mode() ? $this->get_config('live_publickey') : $this->get_config('test_publickey');
     }
     ...
     {
         return $this->get_mode() ? $this->get_config('live_secretkey') : $this->get_config('test_secretkey');
     }
     ...
     public function get_info_icons(array $instances)
     {
         ...
         if ($found) {
             return [new pix_icon('icon', get_string('pluginname', 'enrol_paystack'), 'enrol_paystack')];
         }
         return [];
     }
     ...
     public function get_action_icons(stdClass $instance)
     {
         ...
         if (has_capability('enrol/paystack:config', $context)) {
             $editlink = new moodle_url("/enrol/paystack/edit.php", ['courseid' => $instance->courseid, 'id' => $instance->id]);
     ...
     public function add_course_navigation($instancesnode, stdClass $instance)
     {
         ...
         $context = context_course::instance($instance->courseid);
         if (has_capability('enrol/paystack:config', $context)) {
             $managelink = new moodle_url('/enrol/paystack/edit.php', ['courseid' => $instance->courseid, 'id' => $instance->id]);
     ...
     public function get_unenrolself_link($instance)
     {
         ...
         return new moodle_url("/enrol/$name/unenrolself.php", ['enrolid' => $instance->id]);
     }
     ...
     public function get_newinstance_link($courseid)
     {
         ...
         return new moodle_url('/enrol/paystack/edit.php', ['courseid' => $courseid]);
     }
