...
/** Check if the constant is not already defined before defining it. */
defined('LIVE_MODE_DISABLED') || define('LIVE_MODE_DISABLED', 0);

/** Check if the constant is not already defined before defining it. */
defined('LIVE_MODE_ENABLED') || define('LIVE_MODE_ENABLED', 1);
...
if ($ADMIN->fulltree) {
    ...
    // Note: Let's reuse the external sync constants and strings here, internally it is very similar,
    // and it describes what should happen when users are not supposed to be enrolled anymore.
    $options = array(
